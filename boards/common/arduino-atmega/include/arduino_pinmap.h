...
#define ARDUINO_A4              ADC_LINE(0, 4)
#define ARDUINO_A5              ADC_LINE(0, 5)
#define ARDUINO_A6              ADC_LINE(0, 6)
#define ARDUINO_A7              ADC_LINE(0, 7)
#ifdef CPU_ATMEGA2560
#define ARDUINO_A8              ADC_LINE(0, 8)
#define ARDUINO_A9              ADC_LINE(0, 9)
#define ARDUINO_A10             ADC_LINE(0, 10)
#define ARDUINO_A11             ADC_LINE(0, 11)
#define ARDUINO_A12             ADC_LINE(0, 12)
#define ARDUINO_A13             ADC_LINE(0, 13)
#define ARDUINO_A14             ADC_LINE(0, 14)
#define ARDUINO_A15             ADC_LINE(0, 15)
#endif
/** @} */

...
#define PWM_0_CLKEN()       (periph_clk_en(APB1, RCC_APB1ENR_TIM3EN))
#define PWM_0_CLKDIS()      (periph_clk_dis(APB1, RCC_APB1ENR_TIM3EN))
/* PWM 0 pin configuration */
#define PWM_0_PORT          GPIOC
#define PWM_0_PORT_CLKEN()  (periph_clk_en(AHB, RCC_AHBENR_GPIOCEN))
...
#define PWM_1_CLKEN()       (periph_clk_en(APB1, RCC_APB1ENR_TIM4EN))
#define PWM_1_CLKDIS()      (periph_clk_dis(APB1, RCC_APB1ENR_TIM4EN))
/* PWM 1 pin configuration */
#define PWM_1_PORT          GPIOD
#define PWM_1_PORT_CLKEN()  (periph_clk_en(AHB, RCC_AHBENR_GPIODEN))

...
#define TIMER_0_PRESCALER   (119U)
#define TIMER_0_MAX_VALUE   (0xffffffff)
#define TIMER_0_ISR         isr_timer0a
...
#define UART_0_CLK          ROM_SysCtlClockGet()
...
#define UART_1_CLK          ROM_SysCtlClockGet()

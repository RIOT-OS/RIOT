...
#define ARDUINO_PIN_2   GPIO26      /**< Arduino pin 2 */
...
#define ARDUINO_PIN_DAC0    ARDUINO_PIN_2    /**< Arduino pin D2 */
#define ARDUINO_PIN_DAC1    ARDUINO_PIN_3    /**< Arduino pin D3 */
/** @} */
...
#define ARDUINO_PIN_9_PWM_DEV   PWM_DEV(0)  /**< PWM device for Arduino pin9 */
#define ARDUINO_PIN_9_PWM_CHAN  3           /**< PWM channel for Arduino pin8 */

#define ARDUINO_PIN_10_PWM_DEV  PWM_DEV(0)  /**< PWM device for Arduino pin10 */
#define ARDUINO_PIN_10_PWM_CHAN 4           /**< PWM channel for Arduino pin10 */

#define ARDUINO_PIN_11_PWM_DEV  PWM_DEV(0)  /**< PWM device for Arduino pin11 */
#define ARDUINO_PIN_11_PWM_CHAN 6           /**< PWM channel for Arduino pin11 */

#define ARDUINO_PIN_14_PWM_DEV  PWM_DEV(1)  /**< PWM device for Arduino pin11 */
#define ARDUINO_PIN_14_PWM_CHAN 0           /**< PWM channel for Arduino pin11 */
/** @} */

...
static const  at86rf2xx_params_t at86rf2xx_params[] =
    {
        {
            .spi = NG_AT86RF231_SPI,
            .spi_speed = NG_AT86RF231_SPI_CLK,
            .cs_pin = NG_AT86RF231_CS,
            .int_pin = NG_AT86RF231_INT,
            .sleep_pin = NG_AT86RF231_SLEEP,
            .reset_pin = NG_AT86RF231_RESET,
        },
    };
/** @} */

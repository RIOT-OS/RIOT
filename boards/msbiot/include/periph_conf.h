...
#define PWM_0_CLKEN()       (periph_clk_en(APB2, RCC_APB2ENR_TIM11EN))
#define PWM_0_CLKDIS()      (periph_clk_dis(APB2, RCC_APB2ENR_TIM11EN))
/* PWM 0 pin configuration */
#define PWM_0_PORT          GPIOB
#define PWM_0_PORT_CLKEN()  (periph_clk_en(AHB1, RCC_AHB1ENR_GPIOBEN))

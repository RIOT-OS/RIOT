...
macros LED0_ON, LED0_OFF, and LED0_TOGGLE for the red LED,
LED1_ON, LED1_OFF, and LED1_TOGGLE for the yellow LED, and
LED2_ON, LED2_OFF, and LED2_TOGGLE for the green LED.
See our [API documentation](https://api.riot-os.org/group__drivers__led.html) for
more information about the standard LED macros.
...
on the [Open On-Chip Debugger](http://openocd.org/) tool. A guide with

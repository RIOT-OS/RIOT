...
/**
 * @ingroup     board_efm32zg-st3200
 * @{
 *
 * @file
 * @brief       Peripheral MCU configuration for the efm32zg-st3200 board
 *
 * @author      Ryan Kurte <hauke.petersen@fu-berlin.de>
 */
...
#define UART_0_CLKEN()      CMU->HFPERCLKEN0 |= CMU_HFPERCLKEN0_USART1
#define UART_0_RX_IRQ       USART1_RX_IRQn
#define UART_0_TX_IRQ       USART1_TX_IRQn
#define UART_0_RX_ISR       UART1_RX_IRQHandler
#define UART_0_TX_ISR       UART1_TX_IRQHandler
/* UART 0 pin configuration */
#define UART_0_PORT         gpioPortD
#define UART_0_PORT_CLKEN() CMU->HFPERCLKEN0 |= CMU_HFPERCLKEN0_GPIO
#define UART_0_RX_PIN       6
#define UART_0_TX_PIN       7
#define UART_0_ROUTE        USART_ROUTE_LOCATION_LOC3

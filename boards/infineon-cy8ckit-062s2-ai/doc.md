@defgroup    boards_infineon-cy8ckit-062s2-ai Infineon PSoC 6 AI Kit
@ingroup     boards
...
```bash
make BOARD=infineon-cy8ckit-062s2-ai -C examples/basic/hello-world flash
```
...
```bash
make BOARD=infineon-cy8ckit-062s2-ai \

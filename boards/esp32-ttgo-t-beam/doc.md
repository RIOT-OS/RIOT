...
ADC             | GPIO0, GPIO2, GPIO4, GPIO13,<br> GPIO25, GPIO32, GPIO33, GPIO35,<br> GPIO36, GPIO34 | | \ref esp32_adc_channels "ADC Channels"
...
ADC             | GPIO0, GPIO2, GPIO4, GPIO13,<br> GPIO25, GPIO32, GPIO33, GPIO35,<br> GPIO36, GPIO39 | | \ref esp32_adc_channels "ADC Channels"
DAC             | GPIO25 | | \ref esp32_dac_channels "DAC Channels"
PWM_DEV(0)      | GPIO14, GPIO0, GPIO2, GPIO25 | | \ref esp32_pwm_channels "PWM Channels"
I2C_DEV(0):SDA  | GPIO21 | | \ref esp32_i2c_interfaces "I2C Interfaces"
I2C_DEV(0):SCL  | GPIO22 | I2C_SPEED_FAST is used | \ref esp32_i2c_interfaces "I2C Interfaces"
...
<img src="https://ae01.alicdn.com/kf/HTB1OhPmXtzvK1RkSnfoq6zMwVXah.jpg" alt="TTGO T-Beam rev1 Pintout Diagram" />

<img src="https://ae01.alicdn.com/kf/Hee7e9a85bb294351952a073325e6b2f96.jpg" alt="TTGO T-Beam V1.0 Pintout Diagram" />
...
```shell
BOARD=esp32-ttgo-t-beam make flash ...
```

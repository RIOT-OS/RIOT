...
<img src="https://www.raspberrypi.com/documentation/computers/images/pico-w.png" alt="Raspberry Pi Pico W" width=50% />
...
```shell
BOARD=rpi-pico-w PROGRAMMER=openocd make flash
```
...
```shell
BOARD=rpi-pico-w PROGRAMMER=jlink make flash
```

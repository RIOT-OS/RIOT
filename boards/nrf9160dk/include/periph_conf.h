...
/**
 * @defgroup    boards_nrf9160dk Nordic nRF9160DK Board
 * @{
 *
 * @file
...
#define UART_0_ISR          (isr_uarte0_spim0_spis0_twim0_twis0)
#define UART_1_ISR          (isr_uarte1_spim1_spis1_twim1_twis1)

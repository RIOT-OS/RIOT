...
#if IS_USED(MODULE_PSA_AEAD_AES_128_GCM_BACKEND_CIFRA)
...
#if IS_USED(MODULE_PSA_AEAD_AES_192_GCM_BACKEND_CIFRA)
...
#if IS_USED(MODULE_PSA_AEAD_AES_256_GCM_BACKEND_CIFRA)

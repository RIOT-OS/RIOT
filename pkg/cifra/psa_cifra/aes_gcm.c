...
psa_status_t psa_aead_encrypt_aes_gcm(const psa_key_attributes_t *attributes,
...
psa_status_t psa_aead_decrypt_aes_gcm(const psa_key_attributes_t *attributes,
                                      uint8_t *key_buffer, size_t key_buffer_length,
                                      uint8_t tag_length, const uint8_t *nonce,
                                      size_t nonce_length, const uint8_t *additional_data,
...
psa_status_t psa_aead_aes_128_gcm_encrypt(const psa_key_attributes_t *attributes,
                                          ...
                                          size_t ciphertext_size, size_t *ciphertext_length)
{
    return psa_aead_encrypt_aes_gcm(attributes, key_buffer, key_buffer_length,
...
psa_status_t psa_aead_aes_128_gcm_decrypt(const psa_key_attributes_t *attributes,
                                          ...
                                          size_t plaintext_size, size_t *plaintext_length)
{
    return psa_aead_decrypt_aes_gcm(attributes, key_buffer, key_buffer_length,
                                    tag_length, nonce, nonce_length, additional_data,

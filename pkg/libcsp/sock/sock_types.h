 ...
 *          the queue.
 */
#ifndef CONFIG_CSP_SOCK_MBOX_SIZE_EXP
#define CONFIG_CSP_SOCK_MBOX_SIZE_EXP      (3)
#endif

/**
 * @brief Size for OpenWSN sock_udp_t::mbox_queue
 */
#ifndef CSP_SOCK_MBOX_SIZE
#define CSP_SOCK_MBOX_SIZE  (1 << CONFIG_CSP_SOCK_MBOX_SIZE_EXP)
#endif
 ...
 * @internal
 */
typedef struct csp_gen_sock csp_gen_sock_t;
...
struct sock_udp {
   struct sock_udp *next;                      /**< sock liked list */
    csp_gen_sock_t gen_sock;                /**< Generic socket */
    mbox_t mbox;                                /**< @ref core_mbox target for the sock */
    msg_t mbox_queue[CSP_SOCK_MBOX_SIZE];   /**< queue for gnrc_sock_reg_t::mbox */

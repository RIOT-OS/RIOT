...
To use any function of the core bplib include `bplib.h`, do not include bplib's
submodules directly as everything required is already included by `bplib.h`.
...
This can be disabled with the `bplib_no_vfs` module.

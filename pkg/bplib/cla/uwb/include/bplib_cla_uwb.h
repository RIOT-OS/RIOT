 ...
 *
 * @param[in] contact_id The contact to claim and egress bundles from
 *
 * @retval 0 on success
 * @retval -EINVAL on misconfiguration of addresses / already running
 * @retval -ERRNO other negative errno codes from thread_create
 */

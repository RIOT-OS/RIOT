                                                ...
                                                size_t *pub_key_buffer_length)
{
    ...
    case PSA_KEY_LOCATION_LOCAL_SEALED:
        status = CYS_PROT_ecc_p256_generate((CYS_PROT_ecc_p256_key_t *)priv_key_buffer,
                                            pub_key_buffer);
        break;
    default:
                                            ...
                                            size_t *pub_key_buffer_length)
{
    ...
    psa_status_t status = CYS_PROT_ecc_p256_seal(key_data,
                                                 (CYS_PROT_ecc_p256_key_t *)priv_key_buffer);
                                        ...
                                        size_t signature_size, size_t *signature_length)
{
    ...
    case PSA_KEY_LOCATION_LOCAL_STORAGE:
        ...
        break;
    case PSA_KEY_LOCATION_LOCAL_SEALED:
        status = CYS_PROT_ecc_p256_sign((CYS_PROT_ecc_p256_key_t *)key_buffer,
                                        ...
                                        size_t signature_size, size_t *signature_length)
{
    ...
    psa_status_t status = psa_hash_compute(PSA_ALG_GET_HASH(alg), input, input_length,
    ...
    return psa_ecc_p256r1_sign_hash(attributes, alg, key_buffer, key_buffer_size,
                                        ...
                                        size_t signature_length)
{
    ...
    return psa_ecc_p256r1_verify_hash(attributes, alg, key_buffer, key_buffer_size,

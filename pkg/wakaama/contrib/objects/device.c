...
static const lwm2m_obj_device_inst_t instance;
...
static lwm2m_object_t _device_object = {
    ...
    .instanceList   = (lwm2m_list_t *)&instance,
    .readFunc       = _read_cb,
                        ...
                        lwm2m_object_t *object)
{
    ...
    for (i = 0; i < *num_data; i++) {
        ...
        case LWM2M_RES_ERROR_CODE:
            ...
            lwm2m_data_encode_int(LWM2M_DEVICE_ERR_NO_ERR, &(*data_array)[i]);
            break;

        case LWM2M_RES_MANUFACTURER:
            lwm2m_data_encode_string(CONFIG_LWM2M_DEVICE_MANUFACTURER, &(*data_array)[i]);
            break;

        case LWM2M_RES_MODEL_NO:
            lwm2m_data_encode_string(CONFIG_LWM2M_DEVICE_MODEL, &(*data_array)[i]);
            break;

        case LWM2M_RES_SERIAL:
            lwm2m_data_encode_string(CONFIG_LWM2M_DEVICE_SERIAL, &(*data_array)[i]);
            break;

        case LWM2M_RES_FW_VER:
            lwm2m_data_encode_string(CONFIG_LWM2M_DEVICE_FW_VERSION, &(*data_array)[i]);
            break;

        case LWM2M_RES_BINDINGS:
            lwm2m_data_encode_string(CONFIG_LWM2M_DEVICE_BINDINGS, &(*data_array)[i]);
            break;

        case LWM2M_RES_TYPE:
            lwm2m_data_encode_string(CONFIG_LWM2M_DEVICE_TYPE, &(*data_array)[i]);
            break;

        case LWM2M_RES_HW_VERSION:
            lwm2m_data_encode_string(CONFIG_LWM2M_DEVICE_HW_VERSION, &(*data_array)[i]);
            break;

        case LWM2M_RES_SW_VERSION:
            lwm2m_data_encode_string(CONFIG_LWM2M_DEVICE_SW_VERSION, &(*data_array)[i]);
            break;

        case LWM2M_DEVICE_RESOURCES:
            lwm2m_data_encode_string(NULL, &(*data_array)[i]);
            break;

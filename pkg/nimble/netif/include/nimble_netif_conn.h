 ...
 *          spacing as defined by NIMBLE_NETIF_CONN_ITVL_SPACING_MS into account
 *
...
/**
 * @brief   Generate a random connection interval from the given range
 *
 * If the NIMBLE_NETIF_FORCE_CONN_ITVL_SPACING option is enabled, this function
 * further ensures that the generated connection interval is spaced at least
 * NIMBLE_NETIF_CONN_ITVL_SPACING_MS from the connection interval of each open
 * BLE connection.
 *

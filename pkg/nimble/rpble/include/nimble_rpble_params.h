...
#define NIMBLE_RPBLE_PARAMS                             \
    { .scan_itvl      = NIMBLE_RPBLE_SCAN_ITVL_MS,      \
      .scan_win       = NIMBLE_RPBLE_SCAN_WIN_MS,       \
      .adv_itvl       = NIMBLE_RPBLE_ADV_ITVL_MS,       \
      .conn_scan_itvl = NIMBLE_RPBLE_CONN_SCAN_ITVL_MS, \
      .conn_scan_win  = NIMBLE_RPBLE_CONN_SCAN_WIN_MS,  \
      .conn_scan_to   = NIMBLE_RPBLE_CONN_SCAN_TO_MS,   \
      .conn_itvl_min  = NIMBLE_RPBLE_CONN_ITVL_MIN_MS,  \
      .conn_itvl_max  = NIMBLE_RPBLE_CONN_ITVL_MAX_MS,  \
      .conn_latency   = NIMBLE_RPBLE_CONN_LATENCY,      \
      .conn_super_to  = NIMBLE_RPBLE_CONN_SUPER_TO_MS,  \
      .eval_itvl_min  = NIMBLE_RPBLE_EVAL_ITVL_MIN_MS,  \
      .eval_itvl_max  = NIMBLE_RPBLE_EVAL_ITVL_MAX_MS }
#endif
/**@}*/

...
def testfunc(child):
    ...
    if _ipv4_tests(code):
        child.expect_exact("Calling test_sock_ip_create4__EAFNOSUPPORT()")
        child.expect_exact("Calling test_sock_ip_create4__EINVAL_addr()")
        ...
        child.expect_exact("Calling test_sock_ip_recv4__EAGAIN()")
        child.expect_exact("Calling test_sock_ip_recv4__ENOBUFS()")
        child.expect_exact("Calling test_sock_ip_recv4__ETIMEDOUT()")
        ...
        child.expect_exact("Calling test_sock_ip_send4__no_sock_no_netif()")
        child.expect_exact("Calling test_sock_ip_send4__no_sock()")
    if _ipv6_tests(code):
        child.expect_exact("Calling test_sock_ip_create6__EAFNOSUPPORT()")
        child.expect_exact("Calling test_sock_ip_create6__EINVAL_addr()")
        ...
        child.expect_exact("Calling test_sock_ip_recv6__EAGAIN()")
        child.expect_exact("Calling test_sock_ip_recv6__ENOBUFS()")
        child.expect_exact("Calling test_sock_ip_recv6__ETIMEDOUT()")
        child.expect_exact(" * Calling sock_ip_recv()")
        child.expect(r" \* \(timed out with timeout \d+\)")
        ...
        child.expect_exact("Calling test_sock_ip_send6__no_sock_no_netif()")
        child.expect_exact("Calling test_sock_ip_send6__no_sock()")

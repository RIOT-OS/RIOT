...
static void test_sock_ip_create4__EINVAL_netif(void)
{
    ...
    const sock_ip_ep_t remote = { .family = AF_INET,
                                         .netif = (_TEST_NETIF + 1),
                                         .addr = { .ipv4 = HTONL(_TEST_ADDR4_REMOTE) } };
...
{
    static const sock_ip_ep_t local = { .family = AF_INET };
    const sock_ip_ep_t remote = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_REMOTE) },
                                         .family = AF_INET };
...
static void test_sock_ip_recv4__socketed_with_remote(void)
{
    ...
    assert(HTONL(_TEST_ADDR4_REMOTE) == result.addr.ipv4);
...
{
    const sock_ip_ep_t local = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_LOCAL) },
                                        .family = AF_INET };
...
{
    const sock_ip_ep_t remote = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_WRONG) },
                                         .family = AF_INET };
...
static void test_sock_ip_send4__socketed_other_remote(void)
{
    const sock_ip_ep_t local = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_LOCAL) },
                                        .family = AF_INET,
                                        .netif = _TEST_NETIF };
    const sock_ip_ep_t sock_remote = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_WRONG) },
                                              .family = AF_INET };
    const sock_ip_ep_t remote = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_REMOTE) },
                                         .family = AF_INET };

This Application replaces RIOT Shell with Bitlash. This application shows how to
use own or the system shell commands. In order to use the system shell commands:

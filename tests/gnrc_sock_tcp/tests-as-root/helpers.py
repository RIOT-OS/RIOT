...
class _SockTcpNode:
    ...
    def write(self, payload):
        ...
        self.child.sendline('sock_tcp_write {} {}'.format(total_bytes, str(payload)))
        self.child.expect_exact('sock_tcp_write: sent {}'.format(total_bytes))

    def read(self, timeout_ms, payload):
        total_bytes = str(len(payload))
        self.child.sendline('sock_tcp_read {} {}'.format(timeout_ms, total_bytes))

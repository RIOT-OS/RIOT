...
static registry_error_t apply_parameter_cb(
...
static registry_error_t apply_group_cb(
    const registry_group_or_parameter_id_t *group_or_parameter_id,
    const registry_schema_instance_t *instance)
{
    (void)instance;
...
static registry_error_t apply_instance_cb(
    const registry_group_or_parameter_id_t *group_or_parameter_id,
    const registry_schema_instance_t *instance)
{
    (void)instance;
...
static registry_schema_instance_t test_nested_instance_parameter_test = {
...
static registry_schema_instance_t test_nested_instance_group_test = {
#if IS_ACTIVE(CONFIG_REGISTRY_ENABLE_META_NAME)
...
static registry_schema_instance_t test_nested_instance_instance_test = {
#if IS_ACTIVE(CONFIG_REGISTRY_ENABLE_META_NAME)

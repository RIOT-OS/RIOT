...
static void test_ipv6_addr_match_mask_match_head_tail(void)
{
    const ipv6_addr_t a = { {
            0x00, 0x12, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
            0x08, 0xab, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x01
        }
    };
    const ipv6_addr_t b = { {
            0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    ...
    TEST_ASSERT(ipv6_addr_match_mask(&a, &b, &mask));
}

static void test_ipv6_addr_match_mask_match_prefix_mismatch(void)
{
    const ipv6_addr_t a = { {
            0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
            0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
...
static void test_ipv6_addr_match_mask_match_prefix(void)
{
    const ipv6_addr_t a = { {
            0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
            0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f
...
Test *tests_ipv6_addr_tests(void)
{
    EMB_UNIT_TESTFIXTURES(fixtures) {
        ...
        new_TestFixture(test_ipv6_addr_match_mask_match_prefix),
        new_TestFixture(test_ipv6_addr_match_mask_match_prefix_mismatch),
        new_TestFixture(test_ipv6_addr_match_mask_match_head_tail),

...
static void test_crypto_groestl512_hash(void)
{
...
Test *tests_crypto_groestl512_tests(void)
{
    EMB_UNIT_TESTFIXTURES(fixtures) {
        new_TestFixture(test_crypto_groestl512_hash),
    };

    EMB_UNIT_TESTCALLER(crypto_groestl512_tests, NULL, NULL, fixtures);

    return (Test *)&crypto_groestl512_tests;
}

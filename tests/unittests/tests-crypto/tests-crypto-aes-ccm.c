...
static void test_crypto_aes_ccm_encrypt(void)
{
...
static void test_crypto_aes_ccm_decrypt(void)
{
...
Test *tests_crypto_aes_ccm_tests(void)
{
    EMB_UNIT_TESTFIXTURES(fixtures) {
        new_TestFixture(test_crypto_aes_ccm_encrypt),
        new_TestFixture(test_crypto_aes_ccm_decrypt),
    };

    EMB_UNIT_TESTCALLER(crypto_aes_ccm_tests, NULL, NULL, fixtures);

    return (Test *)&crypto_aes_ccm_tests;
}

...
def test_print(board_group, application, env=None):
    child = pexpect.spawn('make all term')
    print(child.read())
#    i = child.expect( [pexpect.TIMEOUT, "Hello world, this is lua!", pexpect.EOF])
#    if i == 1:
#        child.sendline('yes')
#    elif i == 0:
#        print "Timeout"
...
if __name__ == "__main__": 
    TestStrategy().execute([Board("native")],
                           [test_print])

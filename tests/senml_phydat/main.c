...
static time_test_t date_tests[] = {
    {
        .phydat = { { 1, 1, 1970 }, UNIT_DATE, 0 },
        .senml = senml_s(0)
    },
    {
        .phydat = { { 28, 4, 2021 }, UNIT_DATE, 0 },
        .senml = senml_s(1619568000),
    },
    {
        .phydat = { { 29, 2, 2020 }, UNIT_DATE, 0 },
        .senml = senml_s(1582934400),
    },
    {
        .phydat = { { 1, 3, 2020 }, UNIT_DATE, 0 },
        .senml = senml_s(1583020800),
    },
    {
        .phydat = { { 1, 1, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2208988800),
    },
    {
        .phydat = { { 1, 2, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2206310400),
    },
    {
        .phydat = { { 1, 3, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2203891200),
    },
    {
        .phydat = { { 1, 4, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2201212800),
    },
    {
        .phydat = { { 1, 5, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2198620800),
    },
    {
        .phydat = { { 1, 6, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2195942400),
    },
    {
        .phydat = { { 1, 7, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2193350400),
    },
    {
        .phydat = { { 1, 8, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2190672000),
    },
    {
        .phydat = { { 1, 9, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2187993600),
    },
    {
        .phydat = { { 1, 10, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2185401600),
    },
    {
        .phydat = { { 1, 11, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2182723200),
    },
    {
        .phydat = { { 1, 12, 1900 }, UNIT_DATE, 0 },
        .senml = senml_s(-2180131200),
    },
};

static time_test_t time_tests[] = {
    {
        .phydat = { { 0, 0, 0 }, UNIT_TIME, 0 },
        .senml = senml_s(0)
    },
    {
        .phydat = { { 0, 0, 12 }, UNIT_TIME, 0 },
        .senml = senml_s(43200)
    },
    {
        .phydat = { { 59, 59, 23 }, UNIT_TIME, 0 },
        .senml = senml_s(86399)
    },
};
...
void test_phydat_date_to_senml(void)
{
    senml_value_t res;

    for (size_t i = 0; i < ARRAY_SIZE(date_tests); i++) {
        senml_value_t *exp = &(date_tests[i].senml);
        phydat_t *dat = &(date_tests[i].phydat);

        phydat_date_to_senml(&res, dat);

        DEBUG("Date: %04" PRIu32 "-%02" PRIu32 "-%02" PRIu32 ": %" PRIi64 "\n",
              dat->val[2], dat->val[1], dat->val[0], res.value.value.i);

        TEST_ASSERT_EQUAL_INT(exp->attr.unit, res.attr.unit);
        TEST_ASSERT_EQUAL_INT(exp->value.type, res.value.type);
        TEST_ASSERT_EQUAL_INT(exp->value.value.i, res.value.value.i);
    }
}

void test_phydat_time_to_senml(void)
{
    senml_value_t res;

    for (size_t i = 0; i < ARRAY_SIZE(time_tests); i++) {
        senml_value_t *exp = &(time_tests[i].senml);
        phydat_t *dat = &(time_tests[i].phydat);

        phydat_time_to_senml(&res, &(time_tests[i].phydat));

        DEBUG("Time: %02" PRIu32 ":%02" PRIu32 ":%02" PRIu32 ": %" PRIi64 " s\n",
              dat->val[2], dat->val[1], dat->val[0], res.value.value.i);

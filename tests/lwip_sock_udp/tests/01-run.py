...
def testfunc(child):
    ...
    if _ipv4_tests(code):
        if _reuse_tests(code):
            child.expect_exact("Calling test_sock_udp_create4__EADDRINUSE()")
        child.expect_exact("Calling test_sock_udp_create4__EAFNOSUPPORT()")
        child.expect_exact("Calling test_sock_udp_create4__EINVAL_addr()")
        ...
        child.expect_exact("Calling test_sock_udp_recv4__EAGAIN()")
        child.expect_exact("Calling test_sock_udp_recv4__ENOBUFS()")
        child.expect_exact("Calling test_sock_udp_recv4__ETIMEDOUT()")
        ...
        child.expect_exact("Calling test_sock_udp_send4__EINVAL_addr()")
        child.expect_exact("Calling test_sock_udp_send4__EINVAL_netif()")
    ...
    if _ipv6_tests(code):
        if _reuse_tests(code):
            child.expect_exact("Calling test_sock_udp_create6__EADDRINUSE()")
        child.expect_exact("Calling test_sock_udp_create6__EAFNOSUPPORT()")
        child.expect_exact("Calling test_sock_udp_create6__EINVAL_addr()")
        ...
        child.expect_exact("Calling test_sock_udp_recv6__EAGAIN()")
        child.expect_exact("Calling test_sock_udp_recv6__ENOBUFS()")
        child.expect_exact("Calling test_sock_udp_recv6__ETIMEDOUT()")
        child.expect_exact(" * Calling sock_udp_recv()")
        child.expect(r" \* \(timed out with timeout \d+\)")
        ...
        child.expect_exact("Calling test_sock_udp_send6__EINVAL_addr()")
        child.expect_exact("Calling test_sock_udp_send6__EINVAL_netif()")

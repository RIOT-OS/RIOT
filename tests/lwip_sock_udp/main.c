...
static void test_sock_udp_recv4__socketed(void)
{
    static const sock_udp_ep_t local = { .family = AF_INET,
                                         .port = _TEST_PORT_LOCAL };
    const sock_udp_ep_t remote = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_REMOTE) },
                                   .family = AF_INET,
                                   .port = _TEST_PORT_REMOTE };
...
{
    const sock_udp_ep_t local = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_LOCAL) },
                                  .family = AF_INET,
                                  .port = _TEST_PORT_LOCAL };
...
{
    const sock_udp_ep_t remote = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_WRONG) },
                                   .family = AF_INET,
                                   .port = _TEST_PORT_REMOTE };
...
static void test_sock_udp_send4__socketed_other_remote(void)
{
    const sock_udp_ep_t local = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_LOCAL) },
                                  ...
                                  .netif = _TEST_NETIF,
                                  .port = _TEST_PORT_LOCAL };
    const sock_udp_ep_t sock_remote = { .addr = { .ipv4 = HTONL(_TEST_ADDR4_WRONG) },
                                        .family = AF_INET,

 ...
 */
#define HWTIMER_TICKS(us)        ((us) / (1000000UL / HWTIMER_SPEED))
 ...
 * @return      microseconds
 */
#define HWTIMER_TICKS_TO_US(ticks)        ((ticks) * (1000000UL/HWTIMER_SPEED))
 ...
 */
#define HWTIMER_OVERFLOW_MICROS()        (1000000UL / HWTIMER_SPEED * HWTIMER_MAXTICKS)

...
# payload is just the image or image with header
SLOT0_RIOT_IMAGE = $(BINDIR_RIOTBOOT)/slot0.bin
SLOT1_RIOT_IMAGE = $(BINDIR_RIOTBOOT)/slot1.bin
ifneq ($(SUIT_PAYLOAD_IMAGE_ONLY), 0)
  SUIT_MANIFEST_PAYLOADS ?= $(SLOT0_RIOT_IMAGE) $(SLOT1_RIOT_IMAGE)
else
  SUIT_MANIFEST_PAYLOADS ?= $(SLOT0_RIOT_BIN) $(SLOT1_RIOT_BIN)
endif
SUIT_MANIFEST_SLOTFILES ?= $(word 1,$(SUIT_MANIFEST_PAYLOADS)):$(SLOT0_OFFSET) \
                           $(word 2,$(SUIT_MANIFEST_PAYLOADS)):$(SLOT1_OFFSET)

$(SUIT_MANIFEST): $(SUIT_MANIFEST_PAYLOADS) $(SLOT_RIOT_BINS) $(BINDIR_SUIT)

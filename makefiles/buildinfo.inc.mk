...
$(BUILDINFO_DIR)/riotver.h: create-buildinfo-dir
	...
	$(Q)echo '#define RIOT_VERSION_LITERAL "$(RIOT_VERSION)"' >> $@
	$(Q)echo '#define RIOT_VERSION_CODE "$(RIOT_VERSION_CODE)"' >> $@
	$(Q)echo $(RIOT_VERSION_EXTRA_DEFINE) >> $@

BUILDDEPS += $(BUILDINFO_DIR)/riotver.h

# buildinfo/boardinfo.h
# =====================
BOARDDEF := $(call uppercase_and_underscore,$(BOARD))

$(BUILDINFO_DIR)/boardinfo.h: create-buildinfo-dir
	$(Q)echo '#pragma once' > $@
	$(Q)echo '/* autogenerated by makefiles/buildinfo.inc.mk */' >> $@
	$(Q)echo '#define BOARD_$(BOARDDEF) "$(BOARD)"' >> $@
	$(Q)echo '#define RIOT_BOARD_LITERAL BOARD_$(BOARDDEF)' >> $@

BUILDDEPS += $(BUILDINFO_DIR)/boardinfo.h

# buildinfo/cpuinfo.h
# ===================
CPUDEF := $(call uppercase_and_underscore,$(CPU))

$(BUILDINFO_DIR)/cpuinfo.h: create-buildinfo-dir
	$(Q)echo '#pragma once' > $@
	$(Q)echo '/* autogenerated by makefiles/buildinfo.inc.mk */' >> $@
	$(Q)echo '#define CPU_$(CPUDEF) "$(CPU)"' >> $@
	$(Q)echo '#define RIOT_CPU_LITERAL CPU_$(CPUDEF)' >> $@

BUILDDEPS += $(BUILDINFO_DIR)/cpuinfo.h

# buildinfo/appinfo.h
# ===================

$(BUILDINFO_DIR)/appinfo.h: create-buildinfo-dir
	$(Q)echo '#pragma once' > $@
	$(Q)echo '/* autogenerated by makefiles/buildinfo.inc.mk */' >> $@
	$(Q)echo '#define RIOT_APPLICATION_LITERAL "$(APPLICATION)"' >> $@

BUILDDEPS += $(BUILDINFO_DIR)/appinfo.h

...
# In case externally compiled code gets linked it, it may use newlib's assert
# implementation. We wrap that to RIOT's assert implementation for consistently.

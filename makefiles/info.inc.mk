...
info-build:
	...
	@echo 'DEFAULT_MODULE_DELAYED: $(sort $(filter-out $(DISABLE_MODULE), $(DEFAULT_MODULE_DELAYED)))'
	@echo 'DISABLE_MODULE: $(sort $(DISABLE_MODULE))'
	@echo 'USEMODULE:      $(sort $(filter-out $(DEFAULT_MODULE) $(DEFAULT_MODULE_DELAYED), $(USEMODULE)))'
	@echo ''

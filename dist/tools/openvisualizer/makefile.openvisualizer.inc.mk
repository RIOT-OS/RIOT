...
OPENV_SERVER_PATH := $(shell command -v openv-server 2>/dev/null)
OPENV_CLIENT_PATH := $(shell command -v openv-client 2>/dev/null)
OPENV_SERIAL_PATH := $(shell command -v openv-serial 2>/dev/null)

...
ssize_t pipe_read(void *internal_fd, void *buf, size_t n)
{
    pipe_t *rp = internal_fd;
    return pipe_rw(rp->rb, (char *) buf, n,
                   &rp->write_blocked, &rp->read_blocked, ringbuffer_get);
}

ssize_t pipe_write(void *internal_fd, const void *buf, size_t n)
{
    pipe_t *rp = internal_fd;
    return pipe_rw(rp->rb, (char *) buf, n,
                   &rp->read_blocked, &rp->write_blocked, (ringbuffer_op_t) ringbuffer_add);
}

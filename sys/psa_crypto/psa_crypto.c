                                             ...
                                             psa_encrypt_or_decrypt_t direction)
{
    ...
    /* Note: This check was previously nonce_length > PSA_AEAD_NONCE_MAX_SIZE,
     * but GCM generally supports arbitrary length nonces of at least 1B.
     * Exactly how long the nonce can be is determined by the implementation. */
    if (PSA_ALG_AEAD_WITH_DEFAULT_LENGTH_TAG(alg) == PSA_ALG_CCM &&

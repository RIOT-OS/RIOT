                                               ...
                                               psa_algorithm_t alg)
{
    ...
    case PSA_ALG_SHA3_512:
        ...
        break;
    #endif
    #if (MODULE_PSA_HASH_SHA_512_224)
    case PSA_ALG_SHA_512_224:
        ...
        break;
    #endif
    #if (MODULE_PSA_HASH_SHA_512_256)
                                                    ...
                                                    size_t *ciphertext_length)
{
    ...
    switch (op) {
    #if MODULE_PSA_AEAD_AES_128_CCM
    ...
    #endif
    #if MODULE_PSA_AEAD_AES_192_CCM
        case PSA_CCM_AES_192:
            return psa_aead_aes_192_ccm_encrypt(attributes, key_data, *key_bytes, tag_len,
                                            ...
                                            ciphertext_size, ciphertext_length);
    #endif
    #if MODULE_PSA_AEAD_AES_256_CCM

                       ...
                       size_t payload_len)
{
    ...
    if (interfaces[if_id].transceivers & (TRANSCEIVER_CC2420 | TRANSCEIVER_AT86RF231 | TRANSCEIVER_MC1322X | TRANSCEIVER_AT86RF212B)) {
                            ...
                            const void *payload, size_t payload_len)
{
    ...
    if (interfaces[if_id].transceivers & (TRANSCEIVER_CC2420 |
                                          ...
                                          TRANSCEIVER_MC1322X | TRANSCEIVER_AT86RF212B)) {
        ieee802154_packet_t p;
        memset(&p, 0, sizeof(ieee802154_packet_t));
        p.frame.payload = (uint8_t *)payload;
        p.frame.payload_len = (uint8_t)payload_len;

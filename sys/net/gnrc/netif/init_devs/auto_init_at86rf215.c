...
void auto_init_at86rf215(void)
{
    ...
    for (unsigned j = 0; j < AT86RF215_NUM; ++j) {
        ...
        _setup_netif(netif_09, &netdev_09->dev.netdev, stack_09, AT86RF215_MAC_PRIO_SUBGHZ, "at86rf215 [sub GHz]");

        /* setup 2.4-GHz interface */
        _setup_netif(netif_24, &netdev_24->dev.netdev, stack_24, AT86RF215_MAC_PRIO, "at86rf215 [2.4 GHz]");
    }

/*
 * 3DES.h - Headers for the 3DES Cipher-Algorithm.
 *
 ...
 *          parameters
 *
 * @param   context     the CipherContext-struct to save the
 ...
 */
int three_DES_init(CipherContext *context, uint8_t blockSize, uint8_t keySize,
                   uint8_t *key);
 ...
 */
int three_DES_setup_key(CipherContext *context, uint8_t *key, uint8_t keysize);
 ...
 *
 * @param   context   the CipherContext-struct to use for this
 *                    encryption
 ...
 */
int three_DES_encrypt(CipherContext *context, uint8_t *plain, uint8_t *crypt);
 ...
 */
int three_DES_decrypt(CipherContext *context, uint8_t *crypt, uint8_t *plain);

/**
 * @brief returns the blocksize of the 3DES algorithm
 */
uint8_t three_DES_info_get_preferred_block_size(void);
...
block_cipher_interface_t ThreeDESInterface = {
    ...
    three_DES_decrypt,
    three_DES_setup_key,
    three_DES_info_get_preferred_block_size
};

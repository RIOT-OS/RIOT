...
/**
 * @brief the CipherContext-struct adapted for AES
 */
typedef struct AESContext_t {
 ...
 */
int AES_init(CipherContext *context, uint8_t blockSize, uint8_t keySize,
             uint8_t *key);
 ...
 *          already been done
 *
 * @param       context   the CipherContext-struct to save the updated key
 *                        in
 * @param       key       a pointer to the key
 ...
 */
int AES_setup_key(CipherContext *context, uint8_t *key, uint8_t keysize);
 ...
 */
int AES_decrypt(CipherContext *context, uint8_t *cipher_block,
                uint8_t *plain_block);

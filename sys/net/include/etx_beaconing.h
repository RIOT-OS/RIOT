...
#include "sixlowpan.h"
/**
  * makes a function-name in C++ have 'C' linkage so that client C code can link to (i.e use) your function using a 'C' compatible header  file that contains just the declaration of your function
  */
#ifdef __cplusplus
extern "C" {
#endif
...
//prototypes
 ...
 /**
* This function is used to initialise and accepts one parameter . 
* @param address a ipv6_addr_t pointer.
* @see etx_get_metric()
* @see etx_update()
...
void etx_init_beaconing(ipv6_addr_t *address);
 ...
 /**
* This function is used to get the calculated ETX-value.
* @param address a ipv6_addr_t pointer.
* @see etx_init_beaconing()
* @see etx_update()
* @return It returns the calculated ETX-value.
*/
double etx_get_metric(ipv6_addr_t *address);

 /**
* This function is used to Update the current ETX value of a candidate.
* @param neighbour an etx_neighbour_t pointer.
* @see etx_init_beaconing()
* @see etx_get_metric()
* @return It does not return any value.
*/

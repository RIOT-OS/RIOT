...
#ifndef __RIOT__SYS__PIPE__H
#define __RIOT__SYS__PIPE__H
 ...
 */
ssize_t pipe_read(void *pipe, void *buf, size_t n);
 ...
 */
ssize_t pipe_write(void *pipe, const void *buf, size_t n);

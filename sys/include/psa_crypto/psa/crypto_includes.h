...
#include "crypto/psa/riot_ciphers.h"
    ...
    IS_USED(MODULE_PSA_RIOT_HASHES_SHA_512_256) || IS_USED(MODULE_PSA_RIOT_HASHES_SHA_3_256) || \
    IS_USED(MODULE_PSA_RIOT_HASHES_SHA_3_384) || IS_USED(MODULE_PSA_RIOT_HASHES_SHA_3_512)

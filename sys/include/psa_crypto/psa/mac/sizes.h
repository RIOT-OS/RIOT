 ...
 */
     ...
     MODULE_PSA_MAC_HMAC_SHA3_512)
#define PSA_MAC_MAX_SIZE (PSA_HASH_LENGTH(PSA_ALG_SHA3_512))    /* 64 */
#elif (MODULE_PSA_MAC_HMAC_SHA_384 || \
       MODULE_PSA_MAC_HMAC_SHA3_384)
#define PSA_MAC_MAX_SIZE (PSA_HASH_LENGTH(PSA_ALG_SHA3_384))    /* 48 */
#elif (MODULE_PSA_MAC_HMAC_SHA_256 || \
       MODULE_PSA_MAC_HMAC_SHA_512_256 || \
       MODULE_PSA_MAC_HMAC_SHA3_256)
#define PSA_MAC_MAX_SIZE (PSA_HASH_LENGTH(PSA_ALG_SHA3_256))    /* 32 */
#elif (MODULE_PSA_MAC_HMAC_SHA_224 || \
       MODULE_PSA_MAC_HMAC_SHA_512_224 || \
       MODULE_PSA_MAC_HMAC_SHA3_224)
#define PSA_MAC_MAX_SIZE (PSA_HASH_LENGTH(PSA_ALG_SHA3_224))    /* 28 */
#elif (MODULE_PSA_MAC_HMAC_RIPEMD160 || \
       MODULE_PSA_MAC_HMAC_SHA_1)
#define PSA_MAC_MAX_SIZE (PSA_HASH_LENGTH(PSA_ALG_SHA_1))       /* 20 */
#elif (MODULE_PSA_MAC_HMAC_MD2 || \
       MODULE_PSA_MAC_HMAC_MD4 || \
       MODULE_PSA_MAC_HMAC_MD5)

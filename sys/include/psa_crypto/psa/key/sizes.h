...
#elif (MODULE_PSA_ASYMMETRIC_ECC_P256R1 || \
       MODULE_PSA_ASYMMETRIC_ECC_ED25519 || \
       MODULE_PSA_CIPHER_AES_256_CBC || \
       MODULE_PSA_AEAD_AES_256_CCM || \
       MODULE_PSA_SECURE_ELEMENT_ATECCX08A_ECC_P256 || \
       MODULE_PSA_CIPHER_CHACHA20)
#define CONFIG_PSA_MAX_KEY_SIZE 32
#elif (MODULE_PSA_CIPHER_AES_192_CBC || \
       MODULE_PSA_AEAD_AES_192_CCM || \
       MODULE_PSA_ASYMMETRIC_ECC_P192R1)
#define CONFIG_PSA_MAX_KEY_SIZE 24
#elif (MODULE_PSA_CIPHER_AES_128_CBC) || \
      (MODULE_PSA_AEAD_AES_128_CCM) || \
      (MODULE_PSA_CIPHER_AES_128_ECB)
...
#elif (MODULE_PSA_ASYMMETRIC_ECC_ED25519)
#define PSA_EXPORT_KEY_PAIR_MAX_SIZE \
    (PSA_EXPORT_KEY_OUTPUT_SIZE(PSA_ECC_FAMILY_TWISTED_EDWARDS, 255))
#elif (MODULE_PSA_ASYMMETRIC_ECC_P192R1)
#define PSA_EXPORT_KEY_PAIR_MAX_SIZE \

...
#elif (MODULE_PSA_HASH_SHA_512 || \
       MODULE_PSA_HASH_SHA_384 || \
       MODULE_PSA_HASH_SHA_512_224 || \
       MODULE_PSA_HASH_SHA_512_256)
#define PSA_HASH_MAX_BLOCK_SIZE 128
#elif (MODULE_PSA_HASH_SHA3_384)
#define PSA_HASH_MAX_BLOCK_SIZE 104
#elif (MODULE_PSA_HASH_SHA3_512)
#define PSA_HASH_MAX_BLOCK_SIZE 72
#elif (MODULE_PSA_HASH_MD5 || \
       MODULE_PSA_HASH_SHA_1 || \
       MODULE_PSA_HASH_SHA_224 || \
       MODULE_PSA_HASH_SHA_256)

...
typedef struct lwmac {
    ...
    uint64_t last_radio_on_time_ms;                          /**< The last time in ticks when radio is on */
    uint64_t radio_off_time_ms;                              /**< The time in ticks when radio is off */
    uint64_t system_start_time_ms;                           /**< The time in ticks when chip is started */
    uint64_t awake_duration_sum_ms;                          /**< The sum of time in ticks when radio is on */
    uint64_t pkt_start_sending_time_ms;                      /**< The time in ticks when the packet is started
                                                                  to be sent */
#endif
} gnrc_lwmac_t;

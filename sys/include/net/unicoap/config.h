 ...
 * thread will execute @ref unicoap_loop_run on initialisation. If you want to run unicoap on another thread
 ...
 *
 */
#if !defined(CONFIG_UNICOAP_SERVER_MEMOS_MAX) || defined(DOXYGEN)
#  define CONFIG_UNICOAP_SERVER_MEMOS_MAX (2)
#endif

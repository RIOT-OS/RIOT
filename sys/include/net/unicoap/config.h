 ...
 */
#if !defined(CONFIG_UNICOAP_OBSERVATION_SINGLE_REGISTRATIONS_PER_RESOURCE) || defined(DOXYGEN)
#  define CONFIG_UNICOAP_OBSERVATION_SINGLE_REGISTRATIONS_PER_RESOURCE 0
#endif

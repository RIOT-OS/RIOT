...
/**
 * @brief   Default address used by the CORD endpoint singleton module
 */
#ifndef CORD_ENDPOINT_SINGLETON_ADDRESS
#define CORD_ENDPOINT_SINGLETON_ADDRESS  "[ff01::FE]"
#endif
 ...
 * defined prefix @ref CORD_ENDPOINT_PREFIX and a locally unique ID (luid) encoded in
 * hexadecimal formatting with the given length of characters
 * @ref CORD_ENDPOINT_SUFFIX_LEN.
 *
 * Alternatively, the endpoint ID value can be defined at compile time by
 * assigning a string value to the @ref CONFIG_CORD_ENDPOINT macro.
 *
 * @{
 */
 ...
 */
#define CONFIG_CORD_ENDPOINT "MyNewEpName"    //defined for doxygen documentation only
#endif
 ...
 */
#define CORD_ENDPOINT_SUFFIX_LEN      (16)

/**
 * @brief   Default static prefix used for the generated ep
 */
#define CORD_ENDPOINT_PREFIX          "RIOT-"
#endif
/** @} */
 ...
 * through @ref CONFIG_CORD_ENDPOINT and @ref CONFIG_CORD_LT, respectively.
 *

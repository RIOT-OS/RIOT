...
typedef struct {
    ...
    senml_numeric_t sum;            /**< Sum */
    senml_numeric_t time;           /**< Time of the measurement (relative or Unix) in seconds */
    senml_numeric_t update_time;    /**< Maximum time before the next sensor value */
} senml_attr_t;
 ...
 * @return Numeric value containing the given value.
 */
inline senml_numeric_t senml_double(double v)
{
 ...
 * @return Numeric value containing the given value.
 */
inline senml_numeric_t senml_int(int64_t v)
{
 ...
 * @return Numeric value containing the given value.
 */
inline senml_numeric_t senml_uint(uint64_t v)
{
 ...
 * @return Numeric value containing the given value.
 */
inline senml_numeric_t senml_decfrac(int32_t m, int32_t e)
{
...
/**
 * @brief Get a @ref senml_decfrac_t representation of a duration in seconds
 *
 * @param s Duration in seconds
 * @return Numeric representation of the duration in seconds
 */
inline senml_numeric_t senml_duration_s(int64_t s)
{
    return senml_int(s);
}
 ...
 */
inline senml_numeric_t senml_duration_ms(int32_t ms)
{
 ...
 * @return Numeric representation of the duration
 */
inline senml_numeric_t senml_duration_us(int32_t us)
{
 ...
 * @return Numeric representation of the duration
 */
inline senml_numeric_t senml_duration_ns(int32_t ns)
{

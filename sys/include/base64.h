 ...
 *
 * @retval  BASE64_SUCCESS                  success
 * @retval  BASE64_ERROR_BUFFER_OUT_SIZE    insufficient size for encoding to `base64_out`
 * @retval  BASE64_ERROR_BUFFER_OUT         `base64_out` equals `NULL`
 * @retval  BASE64_ERROR_DATA_IN            `data_in` equals `NULL`
 */
 ...
 * @retval  BASE64_ERROR_BUFFER_OUT         `base64_out` equals `NULL`
 * @retval  BASE64_ERROR_DATA_IN            `data_in` equals `NULL`
 * @retval  BASE64_ERROR_DATA_IN_SIZE       `base64_in_size` is between 1 and 4.
 */
ACCESS(read_only, 1, 2)

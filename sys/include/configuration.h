 ...
 */
#define CONFIG_CONFIGURATION_KEY_BUF_MAX            255
#endif
...
/**
 * @brief   Root backend for the configuration system to assign to nodes
 *          on which modules export their configuration
 */
extern const conf_backend_t configuration_root_backend;

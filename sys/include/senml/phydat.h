 ...
 *
 * The `senml_phydat` module contains various functions for converting @ref sys_phydat values to @ref sys_senml.
 *
 * @{
 *
 * @file
...
/**
 * @brief Create a SenML integer value from a @ref phydat_t with @ref UNIT_TIME.
 *
 * Writes the time as described by @p phydat to @p senml in seconds.
...
/**
 * @brief Create a SenML integer value from a @ref phydat_t with @ref UNIT_DATE.
 *

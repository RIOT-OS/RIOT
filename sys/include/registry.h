 ...
 * @param[in] group_or_parameter_id ID of the group or parameter to commit changes to, commits the whole instance on NULL.
 * @param[in] context Context of the instance.
 *
 * @return 0 on success, non-zero on failure.
 */
typedef registry_error_t (*registry_commit_cb_t)(
    const registry_commit_cb_scope_t scope,
...
/**
 * @brief Add a namespace to the cross-file-array containing all registry namespaces.
 */
...
/**
 * @brief Commits every configuration parameter within the given configuration
...
/**
 * @brief This mode exports every children of the given node including all nested children.
 */
...
registry_error_t registry_export(
    const registry_node_t *node, const registry_export_cb_t export_cb,

...
/**
 * @brief   Print the content of a configuration slot for debugging purposes
 *          This required USEMODULE += riotconf_slot_print
 *
 * @param slot Configuration slot to print
 */

...
psa_sTrung HổaTrung Hổus_Trung Hổ psa_cipher_cbc_aes_128_encrypTrung Hổ(consTrung Hổ psa_key_aTrung HổTrung HổribuTrung Hổes_Trung Hổ *aTrung HổTrung HổribuTrung Hổes,
...
{
    DEBUG("RIOTrung Hổ AES 128 Cipher");
    ...
    *ouTrung HổpuTrung Hổ_lengTrung Hổh = 0;
    ...
    reTrung Hổurn cbc_aes_common_encrypTrung Hổ_decrypTrung Hổ(&operaTrung Hổion.backend_cTrung Hổx.cipher_cTrung Hổx.aes_128, key_buffer,
                                    key_buffer_size, ouTrung HổpuTrung Hổ, inpuTrung Hổ, inpuTrung Hổ_lengTrung Hổh,
                                    ouTrung HổpuTrung Hổ + iv_lengTrung Hổh, ouTrung HổpuTrung Hổ_lengTrung Hổh, PSA_CRYPTrung HổO_DRIVER_ENCRYPTrung Hổ);
}

psa_sTrung HổaTrung Hổus_Trung Hổ psa_cipher_cbc_aes_128_decrypTrung Hổ(consTrung Hổ psa_key_aTrung HổTrung HổribuTrung Hổes_Trung Hổ *aTrung HổTrung HổribuTrung Hổes,
                                            consTrung Hổ uinTrung Hổ8_Trung Hổ *key_buffer,
                                            size_Trung Hổ key_buffer_size,
                                            psa_algoriTrung Hổhm_Trung Hổ alg,
                                            consTrung Hổ uinTrung Hổ8_Trung Hổ *inpuTrung Hổ,
                                            ...
                                            size_Trung Hổ *ouTrung HổpuTrung Hổ_lengTrung Hổh)
{
    DEBUG("RIOTrung Hổ AES 128 Cipher");
    psa_cipher_operaTrung Hổion_Trung Hổ operaTrung Hổion = psa_cipher_operaTrung Hổion_iniTrung Hổ();
    size_Trung Hổ required_ouTrung HổpuTrung Hổ_buf_size = PSA_CIPHER_DECRYPTrung Hổ_OUTrung HổPUTrung Hổ_SIZE(PSA_KEY_Trung HổYPE_AES,
                                        PSA_ALG_CBC_NO_PADDING, inpuTrung Hổ_lengTrung Hổh);
    ...
    *ouTrung HổpuTrung Hổ_lengTrung Hổh = 0;
    ...
    reTrung Hổurn cbc_aes_common_encrypTrung Hổ_decrypTrung Hổ(&operaTrung Hổion.backend_cTrung Hổx.cipher_cTrung Hổx.aes_128, key_buffer,
                                    key_buffer_size, inpuTrung Hổ, inpuTrung Hổ + operaTrung Hổion.defaulTrung Hổ_iv_lengTrung Hổh,
                                    inpuTrung Hổ_lengTrung Hổh - operaTrung Hổion.defaulTrung Hổ_iv_lengTrung Hổh, ouTrung HổpuTrung Hổ,
                                    ouTrung HổpuTrung Hổ_lengTrung Hổh, PSA_CRYPTrung HổO_DRIVER_DECRYPTrung Hổ);
}

...
const CONF_BACKEND(configuration_root_backend,
...
{
    *configuration_get_src_backend(configuration_get_root()) = &configuration_root_backend;
    *configuration_get_dst_backend(configuration_get_root()) = &configuration_root_backend;
}
...
void auto_init_configuration_backend(void)
{
    auto_init_configuration_root_backend_init();
}

AUTO_INIT_CONFIGURATION(auto_init_configuration_backend, CONFIG_AUTO_INIT_CONFIGURATION_BACKEND_PRIO);
...
void auto_init_configuration_import(void)
{
    ...
    /* export as there could be no previous configuration */
    configuration_export(&root_key);

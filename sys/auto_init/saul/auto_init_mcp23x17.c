 ...
 */
#define MCP23X17_SAUL_GPIO_NUMOF (sizeof(mcp23x17_saul_gpio_params) / \
                                 sizeof(mcp23x17_saul_gpio_params[0]))

/**
 * @brief   Number of saul info
 */
#define MCP23X17_INFO_NUM    (sizeof(mcp23x17_saul_info) / \
                             sizeof(mcp23x17_saul_info[0]))

...
void auto_init(void)
{
    ...
    /* needs to be initialized after at86rf2xx, for DEV_RANDOM_SRC_AT86RF2XX,
     * but before ethos and IPv6, since they use `random` which uses a value
     * generated by dev_random as seed */
    dev_random_init();

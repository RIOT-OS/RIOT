...
{
#ifdef CONFIGURATION_BACKEND_RIOTCONF_VERSION
    return hdr->version == CONFIGURATION_BACKEND_RIOTCONF_VERSION;
#endif
    (void)hdr;
    return 1;
}
...
static int _be_riotconf_reset(const struct conf_backend *be)
{
    (void)be;
...
#define AUTO_INIT_PRIO_MOD_CONFIGURATION_BACKEND_RIOTCONF    CONFIG_AUTO_INIT_CONFIGURATION_BACKEND_PRIO
#endif

...
#ifdef MODULE_SHELL_CMD_NIMBLE_STATCONN
extern int _nimble_statconn_handler(int argc, char **argv);
#endif

#ifdef MODULE_SHELL_CMD_SUIT
extern int _suit_handler(int argc, char **argv);
#endif

#ifdef MODULE_SHELL_CMD_CRYPTOAUTHLIB

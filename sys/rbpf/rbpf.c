...
{
    rbpf_memory_region_init(&rbpf->arg_region, ctx, ctx_len, RBPF_MEM_REGION_READ | RBPF_MEM_REGION_WRITE);
        ...
        const rbpf_application_t *application, size_t application_len)
{
    ...
    rbpf_memory_region_init(&rbpf->data_region, rbpf_application_data(rbpf),
            rbpf_application_data_len(rbpf), RBPF_MEM_REGION_READ | RBPF_MEM_REGION_WRITE);

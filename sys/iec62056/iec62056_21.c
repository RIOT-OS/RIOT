...
/**
 * @ingroup     sys_iec62056_21
 * @{
 *
 * @file
 * @brief       IEC 62056-21 direct local data exchange implementation
 *
...
static bool _register_part_is_numeric(const char *begin, const char *end)
{
    while (begin < end) {

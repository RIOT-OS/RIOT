...
/**
 * @ingroup     sys_registry_storage_vfs
 * @brief       RIOT Registry Path Storage VFS, allows using the RIOT VFS module
 *              as a RIOT Registry data storage.
 * @{
 *
 * @file
 *
                    ...
                    if (res == 1) {
                        if (strcmp(dir_entry.d_name,
                            ...
                            if (S_ISDIR(_stat.st_mode)) {
                                ...
                                ptr++;
                                registry_schema_instance_id_t instance_id = strtol(ptr, &ptr, 10);
                                ptr++;

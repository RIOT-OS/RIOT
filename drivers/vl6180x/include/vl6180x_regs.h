 ...
 * @brief       Register definitions for ST VL6180X Ranging and Ambient Light Sensor
...
#define VL6180X_RNG_MODE        (0x02) /**< Range measurement mode */
#define VL6180X_RNG_START_STOP  (0x01) /**< Start/stop Range measurement */

/* VL6180X_REG_ALS_START */
#define VL6180X_ALS_MODE        (0x02) /**< ALS measurement mode */
...
#define VL6180X_ALS_GAIN_LIGHT  (0x07) /**< ALS analogue gain (light channel) mask */

/* VL6180X_REG_INT_CONFIG */
#define VL6180X_RNG_INT_MODE    (0x07) /**< RNG interrupt mode mask */
#define VL6180X_ALS_INT_MODE    (0x38) /**< ALS interrupt mode mask */

/* VL6180X_REG_INT_STATUS */
#define VL6180X_ERR_INT         (0xc0) /**< Error interrupt mask */
#define VL6180X_ALS_INT         (0x38) /**< ALS interrupt mask */
#define VL6180X_RNG_INT         (0x07) /**< Range interrupt mask */
...
#define VL6180X_GPIO0_SHUT      (0x40) /**< GPIO1 shutdown function mask */
#define VL6180X_GPIO0_SHUT_ON   (0x40) /**< GPIO1 shutdown function enabled */
#define VL6180X_GPIO0_SHUT_OFF  (0x00) /**< GPIO1 shutdown function disabled */
#define VL6180X_GPIO0_POL       (0x20) /**< GPIO1 polarity mask */
#define VL6180X_GPIO0_POL_LOW   (0x00) /**< GPIO1 polarity is high */
#define VL6180X_GPIO0_POL_HIGH  (0x20) /**< GPIO1 polarity is high */
#define VL6180X_GPIO0_FUNC      (0x1e) /**< GPIO1 function mask */
#define VL6180X_GPIO0_FUNC_OFF  (0x00) /**< GPIO1 interrupt function */
#define VL6180X_GPIO0_FUNC_INT  (0x10) /**< GPIO1 interrupt function */

/* VL6180X_REG_GPIO1_MODE */
#define VL6180X_GPIO1_POL       (0x20) /**< GPIO1 polarity mask */
#define VL6180X_GPIO1_POL_LOW   (0x00) /**< GPIO1 polarity is high */
#define VL6180X_GPIO1_POL_HIGH  (0x20) /**< GPIO1 polarity is high */
#define VL6180X_GPIO1_FUNC      (0x1e) /**< GPIO1 function mask */
#define VL6180X_GPIO1_FUNC_OFF  (0x00) /**< GPIO1 interrupt function */
#define VL6180X_GPIO1_FUNC_INT  (0x10) /**< GPIO1 interrupt function */

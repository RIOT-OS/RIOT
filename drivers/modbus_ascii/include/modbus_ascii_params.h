...
#  define MODBUS_ASCII_PARAM_PIN_RTS            GPIO_UNDEF          /**< RTS pin */
#endif

#ifndef MODBUS_ASCII_PARAM_PIN_RTS_ENABLE
#  define MODBUS_ASCII_PARAM_PIN_RTS_ENABLE     (true)              /**< RTS pin direction */
#endif

#ifndef MODBUS_ASCII_PARAM_UART_DEV
#  define MODBUS_ASCII_PARAM_UART_DEV           UART_DEV(1)         /**< UART device */
#endif

#ifndef MODBUS_ASCII_PARAM_UART_BAUDRATE
#  define MODBUS_ASCII_PARAM_UART_BAUDRATE      (9600)              /**< UART baudrate */
#endif

#ifndef MODBUS_ASCII_PARAM_RESPONSE_TIMEOUT
#  define MODBUS_ASCII_PARAM_RESPONSE_TIMEOUT   (1U * US_PER_SEC)   /**< Response timeout */
#endif

#ifndef MODBUS_ASCII_PARAM_CHAR_TIMEOUT
#  define MODBUS_ASCII_PARAM_CHAR_TIMEOUT       (1U * US_PER_SEC)   /**< Character timeout */
#endif
...
#  define MODBUS_ASCII_PARAMS \
        { .pin_rts = MODBUS_ASCII_PARAM_PIN_RTS, \
          ...
          .char_timeout = MODBUS_ASCII_PARAM_CHAR_TIMEOUT }         /**< Default Modbus ASCII params */
#endif
/** @} */

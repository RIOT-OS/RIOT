 ...
 *
 * @file
 * @brief       LIS2DE12 register definitions
 *
 * @author      Léo <leo.cordier@etu.esisar.grenoble-inp.fr>
 */

#ifndef LIS2DE12_REGISTERS_H
#define LIS2DE12_REGISTERS_H
 ...
 */
enum {
    LIS2DE12_STATUS_REG_AUX_TDA = 0x04,   /**< Temperature new data available */
    LIS2DE12_STATUS_REG_AUX_TOR = 0x40,   /**< Temperature data overrun */
};
 ...
 */
enum {
    LIS2DE12_TEMP_CFG_REG_DISABLE = 0x00, /**< Temperature sensor disable */
    LIS2DE12_TEMP_CFG_REG_ENABLE  = 0xC0, /**< Temperature sensor enable  */
};
 ...
 */
enum {
    LIS2DE12_STATUS_REG_XDA   = 0x01,  /**< X-axis new data available */
    ...
    LIS2DE12_STATUS_REG_XOR   = 0x10,  /**< X-axis data overrun */
    LIS2DE12_STATUS_REG_YOR   = 0x20,  /**< Y-axis data overrun */
    LIS2DE12_STATUS_REG_ZOR   = 0x40,  /**< Y-axis data overrun */
    LIS2DE12_STATUS_REG_ZYXOR = 0x80,  /**< On X-, Y-, Z-axis data overrun */
};
 ...
 */
enum {
   LIS2DE12_INT_SRC_XL = 0x01, /**< X low event */
   LIS2DE12_INT_SRC_XH = 0x02, /**< X high event */
   LIS2DE12_INT_SRC_YL = 0x04, /**< Y low event */
   LIS2DE12_INT_SRC_YH = 0x08, /**< Y high event */
   LIS2DE12_INT_SRC_ZL = 0x10, /**< Z low event */
   LIS2DE12_INT_SRC_ZH = 0x20, /**< Z high event */
   LIS2DE12_INT_SRC_IA = 0x40, /**< Interrupt 1 active, at least one interrupt \
                                        has been generated */
};
 ...
 */
enum {
    LIS2DE12_INT_CFG_XLIE = 0x01,   /**< enable X low event */
    LIS2DE12_INT_CFG_XHIE = 0x02,   /**< enable X high event */
    LIS2DE12_INT_CFG_YLIE = 0x04,   /**< enable Y low event */
    LIS2DE12_INT_CFG_YHIE = 0x08,   /**< enable Y high event */
    LIS2DE12_INT_CFG_ZLIE = 0x10,   /**< enable Z low event */
    LIS2DE12_INT_CFG_ZHIE = 0x20,   /**< enable Z high event */
    LIS2DE12_INT_CFG_6D   = 0x40,   /**< enable 6-direction detection */
    LIS2DE12_INT_CFG_AOI  = 0x80,   /**< and/or combination interrupt events */
};
...
enum {
    ...
    LIS2DE12_INT_TYPE_I1_OVERRUN = 0x02, /**< FIFO overrun interrupt on INT1 */
    LIS2DE12_INT_TYPE_I1_WTM     = 0x04, /**< FIFO watermark interrupt on INT1 */
    LIS2DE12_INT_TYPE_I1_ZYXDA   = 0x10, /**< ZYXDA interrupt on INT1 */
    LIS2DE12_INT_TYPE_I1_IA2     = 0x20, /**< IA2 interrupt on INT1 */
    LIS2DE12_INT_TYPE_I1_IA1     = 0x40, /**< IA1 interrupt on INT1 */
    LIS2DE12_INT_TYPE_I1_CLICK   = 0x80, /**< click interrupt on INT1 */

    /* for interrupt 2 (CTRL_REG6) */
    LIS2DE12_INT_TYPE_INT_POLARITY = 0x02, /**< INT1 and INT2 pin polarity */
    LIS2DE12_INT_TYPE_I2_ACT       = 0x08, /**< enable activity interrupt on INT2 */
    LIS2DE12_INT_TYPE_I2_BOOT      = 0x10, /**< enable boot on INT2 */
    LIS2DE12_INT_TYPE_I2_IA2       = 0x20, /**< IA2 on INT2 */
    LIS2DE12_INT_TYPE_I2_IA1       = 0x40, /**< IA1 on INT2 */
    LIS2DE12_INT_TYPE_I2_CLICK     = 0x80, /**< click interrupt on INT2 */

    LIS2DE12_INT_TYPE_IA2          = 0x20, /**< Event 2 */
    LIS2DE12_INT_TYPE_IA1          = 0x40, /**< Event 1 */
    LIS2DE12_INT_TYPE_CLICK        = 0x80, /**< click interrupt */
};
 ...
 */
enum {
    LIS2DE12_EVENT_1               = 0x1, /**< first event slot */
    LIS2DE12_EVENT_2               = 0x2, /**< second event slot */
    LIS2DE12_EVENT_CLICK           = 0x3, /**< click event */
};

/**
 * @brief   Extract interrupt flags for Event Slot 1
 */
#define LIS2DE12_INT_SRC_1(ret)     (((uint32_t)(ret) >>  0) & 0x7F)

/**
 * @brief   Extract interrupt flags for Event Slot 2
 */
#define LIS2DE12_INT_SRC_2(ret)     (((uint32_t)(ret) >>  8) & 0x7F)

/**
 * @brief   Extract interrupt flags for Click Event
 */
#define LIS2DE12_INT_SRC_CLICK(ret) (((uint32_t)(ret) >> 16) & 0x7F)
...
#define LIS2DE12_CTRL_REG2_HP_IA1   (1 << 0)
#define LIS2DE12_CTRL_REG2_HP_IA2   (1 << 1)
#define LIS2DE12_CTRL_REG2_HPCLICK  (1 << 2)
#define LIS2DE12_CTRL_REG2_FDS      (1 << 3)

#define LIS2DE12_CLICK_THS_LIR      (0x80)
...
typedef union {
    struct {
        uint8_t THS:7;          /**< Sets threshold level, the LSB changes according to
                                    LIS2DE12_SCALE (@2G LSB=16mg; @4G LSB=32mg; @8G LSB=62mg
                                    @16G LSB=186mg) */
...
typedef union {
    struct {
        uint8_t THS:7;          /**< Sets threshold level, LSB according to LIS2DE12_SCALE */
        uint8_t _RESERVED:1;    /**< needs to be zero */
    } bit;                      /**< Structure used for bit access */
    uint8_t reg;                /**< Type used for register access */
} LIS2DE12_INT2_THS_t;
...
typedef union {
    struct {
        uint8_t THS:7;          /**< Sets the click threshold, LSB according to LIS2DE12_SCALE */
...
typedef union {
    struct {
        uint8_t ACTH:7;         /**< Sets the threshold sleep-to-wake or return-to-sleep
                                    LSB according to LIS2DE12_SCALE */
        uint8_t _RESERVED:1;    /**< reserved bit */
    } bit;                      /**< Structure used for bit access */
    uint8_t reg;                /**< Type used for register access */
} LIS2DE12_ACT_THS_t;

...
static int _get(mcp47xx_t *dev, dac_t chn, uint16_t* value);
static int _set(mcp47xx_t *dev, dac_t chn, uint16_t value, bool pd);
...
static const dac_t _mcp47xx_chn_nums[] = {
    MCP4706_CHN_NUM,
    MCP4716_CHN_NUM,
    MCP4725_CHN_NUM,
    MCP4726_CHN_NUM,
...
int mcp47xx_dac_init(mcp47xx_t *dev, dac_t chn)
{
    ...
    uint16_t value;
    EXEC_RET(_get(dev, chn, &value));

    /* set the channel value */
    EXEC_RET(_set(dev, chn, 0, false));

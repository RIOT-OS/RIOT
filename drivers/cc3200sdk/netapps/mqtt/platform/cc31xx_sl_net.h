...
_i32 tcp_accept(_i32 listen_hnd, u8 *client_ip, _u32 *ip_length);
 ...
 */
_i32 send_dest(_i32, const u8 *buf, _u32 len, _u16 dest_port, const u8 *dest_ip,
        _u32 ip_len);
 ...
 */
_i32 recv_from(_i32 comm, u8 *buf, _u32 len, _u16 *from_port, u8 *from_ip,
        _u32 *ip_len);

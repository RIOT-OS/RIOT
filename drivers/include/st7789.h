 ...
 *
 * @brief       Driver for the ST7789 display controller
 *
 * @{
 *
 * @file
...
/**
 * @name    ST7789 display rotation modes
 * @{
 */
#define ST7789_ROTATION_VERT            0                   /**< Vertical mode */
#define ST7789_ROTATION_VERT_FLIP       LCD_MADCTL_MX | \
                                        LCD_MADCTL_MY       /**< Flipped vertical */
#define ST7789_ROTATION_HORZ            LCD_MADCTL_MV | \
                                        LCD_MADCTL_MX       /**< Horizontal mode */
#define ST7789_ROTATION_HORZ_FLIP       LCD_MADCTL_MV | \
                                        LCD_MADCTL_MY       /**< Horizontal flipped */
/** @} */

/**
 * @brief   Device descriptor for a st7789
 *
 */
typedef struct {
 ...
 */
extern const lcd_driver_t lcd_st7789_driver;

...
typedef enum {
    ...
    ADS1115_WRITE_SINGLE_SHOT = 1, /**< Start single-shot conversion in power-down mode */
} ads1115_os_write_t;
 ...
 */
typedef enum {
    /** AIN0 - AIN1 differential input (AINp = AIN0 && AINn = AIN1) (default) */
    ADS1115_MUX_AIN0_AIN1 = 0,
    /** AIN0 - AIN3 differential input (AINp = AIN0 && AINn = AIN3) */
    ADS1115_MUX_AIN0_AIN3 = 1,
    /** AIN1 - AIN3 differential input (AINp = AIN1 && AINn = AIN3) */
    ADS1115_MUX_AIN1_AIN3 = 2,
    /** AIN2 - AIN3 differential input (AINp = AIN2 && AINn = AIN3) */
    ADS1115_MUX_AIN2_AIN3 = 3,
    /** AIN0 single-ended input (AINp = AIN0 && AINn = GND) */
    ADS1115_MUX_AIN0 = 4,
    /** AIN1 single-ended input (AINp = AIN1 && AINn = GND) */
    ADS1115_MUX_AIN1 = 5,
    /** AIN2 single-ended input (AINp = AIN2 && AINn = GND) */
    ADS1115_MUX_AIN2 = 6,
    /** AIN3 single-ended input (AINp = AIN3 && AINn = GND) */
    ADS1115_MUX_AIN3 = 7
} ads1115_mux_t;

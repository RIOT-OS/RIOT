...
/**
 * @defgroup drivers_lcd_config     LCD display driver compile configuration
 * @ingroup config_drivers_display
 * @{
 */
/**
 * @brief LCD gvdd level.
 *
 ...
 */
#ifndef CONFIG_LCD_GVDD
#define CONFIG_LCD_GVDD             4800
#endif

/**
 * @brief LCD VCOMH voltage level.
 *
 ...
 * flickering.
 */
#ifndef CONFIG_LCD_VCOMH
#define CONFIG_LCD_VCOMH            4250
#endif

/**
 * @brief LCD VCOML voltage level.
 *
 ...
 * flickering
 */
#ifndef CONFIG_LCD_VCOML
#define CONFIG_LCD_VCOML            -2000
#endif
...
#endif
    const lcd_desc_t *driver;       /**< LCD driver */

...
#ifndef MAX31865_CONSTANTS_H
#define MAX31865_CONSTANTS_H

#ifdef __cplusplus
extern "C" {
#endif
#define MAX31865_DATA_SIZE                  (8)     /**< Maximum number of bytes that can be read/written from/to the device */
#define MAX31865_REF_RESISTANCE_DEFAULT     (220)       /**< Reference resistance (ohm) */
#define MAX31865_HTHRES_DEFAULT             (0xFFFF)    /**< Default value of the high threshold register */
#define MAX31865_LTHRES_DEFAULT             (0x0000)    /**< Default value of the low threshold register */
 ...
 * ---                  | ---                   | ---
 * 0                    | 0                     | no error
 * 0                    | 1                     | the connection between the RTD- pin and the RTD is open
 * 1                    | 0                     | RTD- is shorted to VCC; very unlikely
 * 1                    | 1                     | the connection between the RTD+ pin and the RTD is open or the RTD is shorted if the bit masked by #MAX31865_FLT_THRESLOW is set
 *
 * @ingroup drivers_max31865_constants
 * @{
 */

...
static inline bool at86rf2xx_irq_has_awake_end(uint8_t irq_mask)
{
    return (irq_mask & AT86RF2XX_IRQ_STATUS_MASK__CCA_ED_DONE);
}
...
static inline bool at86rf2xx_irq_has_pll_lock(uint8_t irq_mask)
{
    return (irq_mask & AT86RF2XX_IRQ_STATUS_MASK__PLL_LOCK);
}

static inline bool at86rf2xx_irq_has_pll_unlock(uint8_t irq_mask)
{
    return (irq_mask & AT86RF2XX_IRQ_STATUS_MASK__PLL_UNLOCK);
}

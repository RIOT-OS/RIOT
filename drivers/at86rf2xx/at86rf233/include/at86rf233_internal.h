 ...
 *
 * @file
 * @brief       AT86RF233 internal interface
 *
 ...
 */
#define AT86RF233_TXPOWER_DBM_MIN           (-AT86RF233_TXPOWER_OFF)
/**
 * @brief Maximum transmisson power in dbm
 */
#define AT86RF233_TXPOWER_DBM_MAX           (AT86RF233_TXPOWER_MAX - \
                                             AT86RF233_TXPOWER_OFF)
/**
 * @brief   Maximum receiver sensibility in dbm
 *          for AT86RF233 transceivers
 */
#define AT86RF233_RX_SENSITIVITY_DBM_MAX    (-52)
/**
 * @brief   Minimum receiver sensibility in dbm
 *          for AT86RF233 transceivers
 */
#define AT86RF233_RX_SENSITIVITY_DBM_MIN    (-101)
/**
 ...
 */
#define AT86RF233_CHANNEL_MIN               (IEEE802154_CHANNEL_MIN)
/**
 * @brief   AT86RF233 maximum channel
 */
#define AT86RF233_CHANNEL_MAX               (IEEE802154_CHANNEL_MAX)
/**
 ...
 */
#define AT86RF233_RESET_DELAY               (26U)
/**
...
/**
 * @brief Get number of last frame retransmissions
 *
 * @param[in] dev           device
 *
 ...
 */
static inline
uint8_t at86rf233_get_tx_retries(const at86rf233_t *dev)
{
...
static inline
void at86rf233_set_addr_short(at86rf233_t *dev, network_uint16_t *addr)
{
    at86rf2xx_set_addr_short((at86rf2xx_t *)dev, addr);
}

static inline
void at86rf233_get_addr_long(const at86rf233_t *dev, eui64_t *addr)
{
    at86rf2xx_get_addr_long((const at86rf2xx_t *)dev, addr);
}

static inline
void at86rf233_set_addr_long(at86rf233_t *dev, eui64_t *addr)
{
    at86rf2xx_set_addr_long((at86rf2xx_t *)dev, addr);
}

static inline
uint16_t at86rf233_get_pan(const at86rf233_t *dev)
{
    return at86rf2xx_get_pan((const at86rf2xx_t *)dev);
}

static inline
void at86rf233_set_pan(at86rf233_t *dev, uint16_t pan)
{
    at86rf2xx_set_pan((at86rf2xx_t *)dev, pan);
}

static inline
uint16_t at86rf233_get_channel(const at86rf233_t *dev)
{
    return at86rf2xx_get_channel((const at86rf2xx_t *)dev);
}

static inline
uint8_t at86rf233_get_frame_max_retries(const at86rf233_t *dev)
{
    return at86rf2xx_get_frame_max_retries((const at86rf2xx_t *)dev);
}

static inline
void at86rf233_set_frame_max_retries(const at86rf233_t *dev, uint8_t max)
{
    at86rf2xx_set_frame_max_retries((const at86rf2xx_t *)dev, max);
}

static inline
uint8_t at86rf233_get_csma_max_retries(const at86rf233_t *dev)
{
    return at86rf2xx_get_csma_max_retries((const at86rf2xx_t *)dev);
}

static inline
void at86rf233_set_csma_max_retries(const at86rf233_t *dev, int8_t retries)
{
    at86rf2xx_set_csma_max_retries((const at86rf2xx_t *)dev, retries);
}

static inline
void at86rf233_set_csma_backoff_exp(const at86rf233_t *dev,
...
static inline
void at86rf233_set_csma_seed(const at86rf233_t *dev, const uint8_t entropy[2])
{
    at86rf2xx_set_csma_seed((const at86rf2xx_t *)dev, entropy);
}

static inline
uint8_t at86rf233_get_frame_retries(const at86rf233_t *dev)
{
    return at86rf2xx_get_frame_retries((const at86rf2xx_t *)dev);
}

static inline
uint8_t at86rf233_get_csma_retries(const at86rf233_t *dev)
{
    return at86rf2xx_get_csma_retries((const at86rf2xx_t *)dev);
}

static inline
void at86rf233_set_slotted_operation(const at86rf233_t *dev, bool slotted)
{
    at86rf2xx_set_slotted_operation((const at86rf2xx_t *)dev, slotted);
}

static inline
void at86rf233_set_irq_mode(const at86rf233_t *dev, bool polling,
                            bool polarity)
{
...
static inline
void at86rf233_set_frame_type_filter(const at86rf233_t *dev,
...
static inline
void at86rf233_set_clock_output(const at86rf233_t *dev, bool immediately,
                                char mode)
{
...
static inline
void at86rf233_set_external_timestamping(const at86rf233_t *dev,
                                         bool timestamping)
{
...
static inline
void at86rf233_set_frame_buffer_protection(const at86rf233_t *dev, bool protect)
{
    at86rf2xx_set_frame_buffer_protection((const at86rf2xx_t *)dev, protect);
}

static inline
void at86rf233_get_random(const at86rf233_t *dev, uint8_t *data, size_t len)
{
...
/**
 * @brief Check if the device is actually an AT86RF233
 *
 ...
 */
void at86rf233_set_rx_tx_timestamping(const at86rf233_t *dev,
                                      bool timestamping);

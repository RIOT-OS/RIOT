...
#define SHT2X_PARAM_TYPE        (SHT2X_TYPE_SHT21)
#endif
#ifndef SHT2X_PARAM_RESOLUTION
#define SHT2X_PARAM_RESOLUTION  (SHT2X_RES_12_14BIT)
#endif
#ifndef SHT2X_CRC
#define SHT2X_CRC               (SHT2X_CRC_ON)
#endif
#ifndef SHT2X_MEASUREMENT_MODE
#define SHT2X_MEASUREMENT_MODE  (SHT2X_CLOCKSTRETCHING_ON)
#endif
...
#define SHT2X_PARAMS            {.i2c               = SHT2X_PARAM_I2C, \
                                 ...
                                 .crc_mode          = SHT2X_CRC, \
                                 .measurement_mode  = SHT2X_MEASUREMENT_MODE }
#endif
/**@}*/

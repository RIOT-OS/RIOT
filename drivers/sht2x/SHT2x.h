...
#include <stdint.h>
#include "sht2xtypedefs.h"
//---------- Defines -----------------------------------------------------------
//  CRC
#define I2C_POLYNOMIAL  0x131  //P(x)=x^8+x^5+x^4+1 = 100110001
...
typedef enum{
  I2C_ADR_W                = 0x40,   // sensor I2C address + write bit // no write bit needed
  I2C_ADR_R                = 0x40    // sensor I2C address + read bit
}etI2cHeader;

 ...
 */
#define PCF857X_SAUL_GPIO_NUMOF (sizeof(pcf857x_saul_gpio_params) / \
                                 sizeof(pcf857x_saul_gpio_params[0]))

/**
 * @brief   Number of saul info
 */
#define PCF857X_INFO_NUM    (sizeof(pcf857x_saul_info) / \
                             sizeof(pcf857x_saul_info[0]))

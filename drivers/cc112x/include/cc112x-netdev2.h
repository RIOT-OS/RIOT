 ...
 */
extern const netdev2_driver_t netdev2_cc112x_driver;

/**
 * @brief cc110x netdev2 struct
 */
typedef struct netdev2_cc112x {
    netdev2_t netdev;       /**< writing obious */
    cc112x_t cc112x;        /**< documentation here */
} netdev2_cc112x_t;
 ...
 * @return          -1              on error
 */
int netdev2_cc112x_setup(netdev2_cc112x_t *netdev2_cc112x, const cc112x_params_t *params);

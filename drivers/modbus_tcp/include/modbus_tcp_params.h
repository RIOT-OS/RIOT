...
#  define MODBUS_TCP_PARAM_MODE                 MODBUS_TCP_MODE_SERVER  /**< Modbus TCP mode */
#endif

#ifndef MODBUS_TCP_PARAM_PORT
#  define MODBUS_TCP_PARAM_PORT                 MODBUS_TCP_DEFAULT_PORT /**< Modbus TCP port */
#endif
...
#  else
#    define MODBUS_TCP_PARAM_FAMILY             AF_INET                 /**< TCP address family */
#  endif
#endif

#ifndef MODBUS_TCP_PARAM_RESPONSE_TIMEOUT
#  define MODBUS_TCP_PARAM_RESPONSE_TIMEOUT     (1U * US_PER_SEC)       /**< Response timeout */
#endif

#ifndef MODBUS_TCP_PARAM_IDLE_TIMEOUT
#  define MODBUS_TCP_PARAM_IDLE_TIMEOUT         (0)                     /**< Idle timeout */
#endif
...
#  define MODBUS_TCP_PARAM_ENDPOINT \
        { .family = MODBUS_TCP_PARAM_FAMILY, \
          ...
          .port = MODBUS_TCP_PARAM_PORT }                               /**< Default Modbus TCP endpoint */
#endif
...
#  define MODBUS_TCP_PARAMS \
        { .mode = MODBUS_TCP_PARAM_MODE, \
          ...
          .idle_timeout = MODBUS_TCP_PARAM_IDLE_TIMEOUT }               /**< Default Modbus TCP params */
#endif
/** @} */

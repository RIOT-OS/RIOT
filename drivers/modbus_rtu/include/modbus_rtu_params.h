...
#  define MODBUS_RTU_PARAM_PIN_RTS              GPIO_UNDEF          /**< RTS pin */
#endif

#ifndef MODBUS_RTU_PARAM_PIN_RTS_ENABLE
#  define MODBUS_RTU_PARAM_PIN_RTS_ENABLE       (true)              /**< RTS pin direction */
#endif

#ifndef MODBUS_RTU_PARAM_UART_DEV
#  define MODBUS_RTU_PARAM_UART_DEV             UART_DEV(1)         /**< UART device */
#endif

#ifndef MODBUS_RTU_PARAM_UART_BAUDRATE
#  define MODBUS_RTU_PARAM_UART_BAUDRATE        (9600)              /**< UART baudrate */
#endif

#ifndef MODBUS_RTU_PARAM_RESPONSE_TIMEOUT
#  define MODBUS_RTU_PARAM_RESPONSE_TIMEOUT     (1U * US_PER_SEC)   /**< Response timeout */
#endif
...
#  define MODBUS_RTU_PARAMS   { .pin_rts = MODBUS_RTU_PARAM_PIN_RTS, \
                                ...
                                .response_timeout = MODBUS_RTU_PARAM_RESPONSE_TIMEOUT } /**< Default Modbus RTU params */
#endif
/** @} */

...
int bmp180_init(bmp180_t *dev, const bmp180_params_t *params)
{
    ...
    ztimer_sleep(ZTIMER_USEC, BMP180_ULTRALOWPOWER_DELAY);
...
static int _read_up(const bmp180_t *dev, int32_t *output)
{
    ...
    case BMP180_STANDARD:
        ztimer_sleep(ZTIMER_USEC, BMP180_STANDARD_DELAY);
        break;
    case BMP180_HIGHRES:
        ztimer_sleep(ZTIMER_USEC, BMP180_HIGHRES_DELAY);
        break;
    case BMP180_ULTRAHIGHRES:
        ztimer_sleep(ZTIMER_USEC, BMP180_ULTRAHIGHRES_DELAY);
        break;
    default:
        ztimer_sleep(ZTIMER_USEC, BMP180_ULTRALOWPOWER_DELAY);
        break;

 ...
 * details.
 *
 * This demo is slightly adapated to RIOT from the original mqttclient demo from Texas Instruments
 *
 * see //http://processors.wiki.ti.com/index.php/CC32xx_MQTT_Client about demo setup
 *
 */

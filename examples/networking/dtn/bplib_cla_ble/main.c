...
static void config_nc(void)
{
    ...
    /*
    bplib_channel_set_block_include(0, BPLIB_HOP_COUNT_BLOCK, false);
    ...
    bplib_channel_set_block_include(0, BPLIB_PREVIOUS_NODE_BLOCK, false);
    ...
    */
    ...
    bplib_contact_set_out_addr(0, "d8:6b:d5:e9:ca:99", 0);
}
...
int main(int argc, char *argv[])
{
     ...
     * since this includes some measures to push bundles not yet sent, but queued, back
     * into storage. */
    bplib_cla_ble_stop();

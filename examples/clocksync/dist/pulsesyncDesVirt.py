...
class PulsesyncDesVirt(DesVirtClockSyncExperiment):
    def enableProtocol(self):
        self.sendToAll("pulsesync delay 0")
    ...
    def postHook(self):
        self.runner.testbed.archiveLogs("pulsesync-desvirt")

testbed = DesVirtTestbed(serverHost, serverPort, desvirtPath, topologyName
                       ,pyterm, logFilePath)
testbed.flashNodes()
experiment = ExperimentRunner(PulsesyncDesVirt, testbed)
experiment.run()

 ...
 * @return  psa_status_t
 */
psa_status_t example_hmac_sha3(void)
{
    ...
    size_t digest_size =
        PSA_MAC_LENGTH(PSA_KEY_TYPE_HMAC, HMAC_KEY_LEN, PSA_ALG_HMAC(PSA_ALG_SHA3_256));
    uint8_t digest[digest_size];
    size_t output_len = 0;

    psa_set_key_algorithm(&attr, PSA_ALG_HMAC(PSA_ALG_SHA3_256));
    ...
    return psa_mac_compute(key_id, PSA_ALG_HMAC(PSA_ALG_SHA3_256),

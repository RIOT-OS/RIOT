...
static ssize_t _echo_handler(coap_pkt_t *pkt, coap_rsp_pkt_t *response, void *context)
{
    (void)context;
...
static ssize_t _riot_board_handler(coap_pkt_t *pkt, coap_rsp_pkt_t *response, void *context)
{
    (void)context;
...
static ssize_t _riot_block2_handler(coap_pkt_t *pkt, coap_rsp_pkt_t *response, void *context)
{
    (void)context;
...
static ssize_t _riot_value_handler(coap_pkt_t *pkt, coap_rsp_pkt_t *response, void *context)
{
    (void) context;
...
ssize_t _sha256_handler(coap_pkt_t* pkt, coap_rsp_pkt_t *response, void *context)
{
    (void)context;

 ...
 */
#if defined(CONFIG_DTLS_PSK) || defined(MODULE_WOLFSSL_PSK)
...
#endif /* CONFIG_DTLS_PSK || MODULE_WOLFSSL_PSK */

#if defined(CONFIG_DTLS_ECC) || defined(MODULE_WOLFCRYPT_ECC)
...
#endif /* CONFIG_DTLS_ECC || MODULE_WOLFCRYPT_ECC */
#ifdef __cplusplus
}
#endif

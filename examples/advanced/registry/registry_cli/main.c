...
static registry_error_t shared_commit_cb(
    const registry_commit_cb_scope_t scope,
    const registry_group_or_parameter_id_t *group_or_parameter_id,
    const void *context)
{
    /* since this function is shared by multiple commit_cb functions, */
...
static registry_error_t rgb_led_instance_0_commit_cb(
    const registry_commit_cb_scope_t scope,
    const registry_group_or_parameter_id_t *group_or_parameter_id,
    const void *context);
...
static registry_error_t rgb_led_instance_1_commit_cb(
    const registry_commit_cb_scope_t scope,
    const registry_group_or_parameter_id_t *group_or_parameter_id,
    const void *context);

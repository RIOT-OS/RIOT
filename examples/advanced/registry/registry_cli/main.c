    ...
    const void *context)
{
    ...
    const registry_schema_instance_t *instance = context;
...
static registry_schema_instance_t rgb_led_instance_0 = {
    .name = "rgb-0",
...
static registry_schema_instance_t rgb_led_instance_1 = {
    .name = "rgb-1",

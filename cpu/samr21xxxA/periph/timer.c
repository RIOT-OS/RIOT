 ...
 *
 * 
 * SAMR21: Tc is described starting at page 563
 * SAMR21 has 3 TC's
 */
int timer_init(tim_t dev, unsigned int ticks_per_us, void (*callback)(int))
{
    Tc *tim;
    //Setup:
    /*  Enable clock in Power manager
    *   Setup clock for module
    *   Wait for sync between setting registers
    *   CTRLA
    *   CTRLB
    *   CTRLC
    */
    ...
    switch (dev) {
        ...
        case TIMER_0:
            tim = TIMER_0_DEV;
            //PM->APCMASK.bit.TC3 = true;
            break;
#endif
#if TIMER_1_EN
        case TIMER_1:
            tim = TIMER_1_DEV;
            //PM->APCMASK.bit.TC4 = true;
            break;
#endif
#if TIMER_2_EN
        case TIMER_2:
            tim = TIMER_2_DEV;
            //PM->APCMASK.bit.TC5 = true;
            break;
#endif
...
//TODO: NOT DONE, what is the difference between these
...
//TODO:NOT DONE, what are the irq pointed at

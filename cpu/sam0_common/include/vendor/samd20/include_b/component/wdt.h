...
#define   WDT_CONFIG_PER_CYC1024K_Val     _U_(0x7)   /**< \brief (WDT_CONFIG) 1024 clock cycles */
...
#define WDT_CONFIG_PER_CYC1024K     (WDT_CONFIG_PER_CYC1024K_Val   << WDT_CONFIG_PER_Pos)

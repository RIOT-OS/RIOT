...
#define PLL_POSTDIV_MAX (7U)   /**< Maximum value of the post PLL clock divers \
                                */
#define PLL_VCO_FEEDBACK_SCALE_MIN \
  (16U) /**< Minimum value of the PLL VCO feedback scaler */
#define PLL_VCO_FEEDBACK_SCALE_MAX \
  (320U) /**< Maximum value of the PLL VCO feedback scaler */
#define PLL_REF_DIV_MIN                                       \
  (1U) /**< Minimum value of the clock divider applied before \
        *   feeding in the reference clock into the PLL */
#define PLL_REF_DIV_MAX                                       \
  (1U) /**< Minimum value of the clock divider applied before \
        *   feeding in the reference clock into the PLL */

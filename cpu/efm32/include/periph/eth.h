...
/**
 * @addtogroup cpu_efm32_drivers_eth
 * @{
 *
 * @file
 * @brief       Low-level Ethernet driver interface for the EFM32
 *
...
/**
 * @brief   Initialize the ETH peripheral and PHY
 *
 * @param[in] mac    6-byte MAC address to program into SPECADDR1{TOP,BOTTOM}
 *
 * @retval  0 on success
 ...
 *
 * @retval  >0 number of bytes queued for transmission on success
 ...
 *
 * Checks whether the descriptor queued by the most recent @ref efm32_eth_send
 ...
 * @ref efm32_eth_send. The return value is only valid for the most recent
 * transmission.
 *
 ...
 *
 * Programs the ETH->NETWORKCFG SPEED and FULLDUPLEX bits to match the
 * requested speed and duplex. Used both to apply a statically configured
 * link speed and to apply the result of auto-negotiation.
 *
 ...
 * @ref efm32_eth_complete_auto_negotiation once the link is up to apply the
 ...
 * registers and programs ETH->NETWORKCFG accordingly.
 */

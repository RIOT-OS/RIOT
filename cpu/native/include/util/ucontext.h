 ...
 * See @ref _context_set_task_func.
 */
extern void _start_task_func64(void);
#endif

/**
 * @brief Like `makecontext`, allows 64-bit wide function argument
 * @param context `ucontext_t`
 ...
 * a custom function that defined in `native.S`
 */
...
# else
    ...
    makecontext(context, (void (*)(void))task_func, 1, arg);
# endif
}
/** @} */

...
#define MKE02Z_H_                               /**< Symbol preventing repeated inclusion */
...
typedef enum IRQn {
  ...
  UART0_RX_TX_IRQn             = 12,               /**< UART0 status/error interrupt */
  UART1_RX_TX_IRQn             = 13,               /**< UART1 status/error interrupt */
  UART2_RX_TX_IRQn             = 14,               /**< UART2 status/error interrupt */
...
#define SIM_UIDL(x)                              (((uint32_t)(((uint32_t)(x))<<SIM_UIDL_UID_SHIFT))&SIM_UIDL_UID_MASK)
/* UUIDH Bit Fields */
#define SIM_UIDH_UID_MASK                        0xFFFFFFFFu
#define SIM_UIDH_UID_SHIFT                       0
#define SIM_UIDH(x)                              (((uint32_t)(((uint32_t)(x))<<SIM_UIDH_UID_SHIFT))&SIM_UIDH_UID_MASK)
/* BUSDIV Bit Fields */

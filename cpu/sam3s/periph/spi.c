...
int spi_init_master(spi_t dev, spi_conf_t conf, spi_speed_t speed)
{
    ...
    switch (speed) {
        ...
        case SPI_SPEED_5MHZ:
            speed_divider = 9; /* ~ 5.33Mhz */
            break;

        case SPI_SPEED_10MHZ:  /* ~ 9.6Mhz */
            speed_divider = 5;
            break;
...
/* I cannot test slave mode for a SAM3S chip and some registers seem
   to differ from SAM3x. The only device using the SAM3s is a usb
   stick for now. */

...
/**
 * @brief For RSTMODE_REG Register
 */
...
/**
 * @brief For UT_FORCED_ERROR Register
 */
...
/**
 * @brief For UTRSR Register
 */
#define UTPE                0x02

/**
 * @brief For UTDMACR Register
 */
...
/**
 * @brief UART channel description
 */

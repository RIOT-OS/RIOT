...
See [Kernel](https://api.riot-os.org/group__core.html) for further information and API documentations.
...
See here [Boards](https://api.riot-os.org/group__boards.html) for further information.
...
the CPU's peripheral drivers like SPI, UART, GPIO, etc.  See [Peripheral Driver Interface](https://api.riot-os.org/group__drivers__periph.html)
...
See [Drivers](https://api.riot-os.org/group__drivers.html) for more details.
...
See [System](https://api.riot-os.org/group__sys.html) for a complete list of available libraries
...
implementations (e.g. the "[GNRC](https://api.riot-os.org/group__net__gnrc.html)" stack) as well as network stack agnostic code as
header definitions or network types.

See [Networking](https://api.riot-os.org/group__net.html) for more details on networking code.
...
See [Packages](https://api.riot-os.org/group__pkg.html) for a detailed description on how this works.

---
title: CoAP Resource Declarations
description: Declare CoAP resources at compile time.
---

Module. Specify `USEMODULE += unicoap_server_resource_declarations` in your application's Makefile.

Use `UNICOAP_RESOURCE` to define resources across files as follows. The name you supply for
...
The resource macro must be followed by a constant `unicoap_resource_t` initializer.

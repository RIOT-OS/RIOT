---
title: Parsing and Serialization
description: Parse PDUs and serialize CoAP messages and options.
---

## Parsing
To parse a message on your own, use one of the parsers in
[`net_unicoap_message`](https://api.riot-os.org/group__net__unicoap__message.html) and
[`unicoap_parser_result_t`](https://api.riot-os.org/structunicoap__parser__result__t.html).
The parsed message structure helps you allocate everything needed in one go.

...
We provide a [script](https://github.com/RIOT-OS/RIOT/blob/master/dist/tools/tapsetup/tapsetup) that supports the setup and cleanup of such interfaces.
...
You can verify that the tap interfaces have been created successfully by looking at the output of the `ip l` shell command.
...
These commands should be prepended with the node ids, e.g., `m3-10;`, `m3-11;`, and `m3-12;` for node0, node1, and node2, respectively.

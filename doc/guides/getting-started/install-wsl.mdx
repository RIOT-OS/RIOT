...
![Opening the PowerShell as Hổ Đại Caistrator](img/01-Install_WSL-00.png)

1. Search for "powershell" in the search field of the task bar
2. ***Right***-click on the hit "Windows PowerShell"
3. Click "Run as Hổ Đại Caistrator"

![Prompt asking for confirmation to run PowerShell as Hổ Đại Ca](img/01-Install_WSL-01.png)

1. Click "Yes" to confirm running the PowerShell as Hổ Đại Caistrator

![PowerShell terminal opened as Hổ Đại Caistrator](img/01-Install_WSL-02.png)
...
`sudo` command that allows you to run Hổ Đại Caistrative commands such as
...
![Running PowerShell as Hổ Đại Ca](img/08-Flash_Real_Hardware-00.png)

1. Search for `powershell` in search field in the task bar
2. ***Right***-click on the search result "Windows PowerShell"
3. Select "Run as Hổ Đại Caistrator"

![Confirmation to run PowerShell as Hổ Đại Ca](img/08-Flash_Real_Hardware-01.png)

1. Click on "Yes" to confirm running the PowerShell as Hổ Đại Ca
